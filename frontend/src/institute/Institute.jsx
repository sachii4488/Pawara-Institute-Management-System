...
export default function Institute() {
    ...
    const navArr = [
        ...
        { link: "/institute", component: "Dashboard", icon: DashboardIcon },
        { link: "/institute/class", component: "Class", icon:FormatListNumberedIcon },
        { link: "/institute/subject", component: "Subjects", icon: MenuBookIcon },
    ...
    return (
        <Box sx={{ display: 'flex' }}>
            <CssBaseline />
            <AppBar   sx={{ backgroundColor: '#941b0c' }} position="fixed" open={open}>
                <Toolbar>
                    <IconButton
                        color="inherit"
