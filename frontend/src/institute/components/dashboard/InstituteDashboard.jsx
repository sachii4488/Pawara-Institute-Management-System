...
const handleSubmit = (e)=>{
    ...
    fd.append("institute_name", instituteName)
    if (file) {
      fd.append("image", file, file.name);
    }

    axios
      .patch(`${baseUrl}/institute/update`, fd, {
        headers: {
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <Paper sx={{maxWidth:'780px', margin:"auto",padding:"10px", marginTop:"120px"}} >
       ...
       >
         <Typography sx={{ marginRight: "50px" }} variant="h4"> Institute Pic </Typography>
       ...
       <Button
         ...
         <Button
           onClick={()=>{setInstituteEdit(false)}}
           variant="outlined"
           sx={{ marginTop: "10px" }}
         >
          Cancel
             ...
             Pawara Institute Dashboard 
               {/* {instituteDetails && `[ ${instituteDetails.institute_name} ]`} */}
             </Typography>
           ...
           {preview &&  
            <Box sx={{position:"fixed", top:'0',left:'0', zIndex:'9999',height:'100vh',
              ...
              <CardMedia
               component="img"
               image={`/images/uploaded/institute/${schooImage}`}
               height="100%"
             /> 
    ...
    >
          {/* <Typography variant="h2" sx={{color:'white', fontWeight:"500"}}>{instituteDetails.institute_name}</Typography> */}
          <Box sx={{position:'absolute', bottom:'10px',right:'10px',}} >
            <Button onClick={()=>{setPreview(true)}}>
              <PreviewIcon sx={{color:"#fff", fontSize:'40px'}}/>
            </Button>
{/*           
          <IconButton sx={{background:'white'}} onClick={handleInstituteEdit} color="primary">
            <EditIcon />
          </IconButton> */}
          </Box>
        </Box>
